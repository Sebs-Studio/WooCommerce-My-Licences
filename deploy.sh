# main config
PLUGINSLUG="woocommerce-my-licences" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="woocommerce-my-licences.php" # this should be the name of your main php file in the wordpress plugin
